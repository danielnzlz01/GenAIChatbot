...
def recurring_themes():
    ...
    try:
        ...
        response = chat.send_message("Analyze the chat history. Focus ONLY on the responses when 'role' == 'user' and NOT when 'role' == 'model'.")
        ...
        prompt = f"Analyze the chat history. Focus ONLY on the responses when 'role' == 'user' and NOT when 'role' == 'model'. {loaded_chat_history}"
